...
int main() {
   ...
   for (currObj = headObj->GetNext(); currObj != nullptr; currObj = currObj->GetNext()) {
      if (currObj->GetDataVal() < headObj->GetDataVal()) {
         headObj = currObj;
      }
   }

   cout << "Minimum dataVal: " << headObj->GetDataVal() << endl;
